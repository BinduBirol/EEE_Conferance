...
<div class="">
    ...
    <table class="table table-bordered table-hover">
        ...
        <tr>
            <td>International Authors/Participants</td>
            <td>USD 350</td>
            <td>USD 325</td>
        </tr>
        <tr>
...
<div class="h6">
    ...
    <p>* Only full-time students with proof will be considered for student author category.</p>
...
<div>
    ...
    <ul>
        ...
        <li>Where applicable, proof of studentship, IEEE membership status needs to be submitted.</li>
        <li>All participants should attach the scanned copy of the proof of payment during Online Registration.</li>
        <li>Bank cheque will not be accepted in any circumstance.</li>
        <li>Any type of transfer charge/bank fees/handling fees should be borne by the participants.</li>
    </ul>
</div>
...
<div>
    ...
    <ul>
        ...
        <li>Proof of payment is required in case of Offline mode of payment (e.g. Mobile banking, Pay Order, Cash
            Deposit-Slip or slip of Wired Transfer showing the code)
        </li>
    </ul>
</div>
<div>
