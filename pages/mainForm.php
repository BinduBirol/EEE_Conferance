<div>
    <form action="insert.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group row-fluid">
            <div class="">Name*</div>
            <div class=""><input name="name" type="text" required class="form-control"/></div>
        </div>
        ...
        <div class="row-fluid form-group">
            ...
            <div class="row-fluid form-group">
                <div class="">Do you have IEEE Membership?</div>
                <div class=""><input name="iee_m" type="radio" value="Y"/>&nbsp;Yes&nbsp;&nbsp; <input name="iee_m"
                                                                                                       checked="checked"
                                                                                                       type="radio"
                                                                                                       value="N"/>
                    &nbsp;No
            ...
            <div class="row-fluid form-group">
                ...
                <div class=""><input required name="address" type="text" class="form-control"/></div>
            </div>
            ...
            <div id="file_upload" class="row-fluid form-group">
...
<script>
    //alert($("input[name=iee_m]:checked").val());
    $("#iee_m_id").hide();
    $("#file_upload").hide();
